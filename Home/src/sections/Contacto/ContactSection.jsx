            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className={`text-center mb-16 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
                    <h2 className="text-4xl md:text-5xl font-bold text-white font-mono mb-4">
                        <span className="text-cyan-accent">~/</span>contacto<span className="animate-pulse">_</span>
                    </h2>
                ...
                <div className={`bg-[#0A0A0A] border border-zinc-800 rounded-xl overflow-hidden shadow-2xl ${isVisible ? 'animate-fade-in-up delay-200' : 'opacity-0'}`}>
                    ...
                    <div className="p-6 md:p-8 font-mono">
                        ...
                        <div className="mb-8 text-sm md:text-base text-zinc-400 whitespace-pre-wrap min-h-12">
                            <span className="text-cyan-accent">➜</span> <span className="text-blue-400">~</span> {terminalText}
                            {isTyping && <span className="inline-block w-2 h-4 bg-cyan-accent ml-1 animate-pulse"></span>}
                        </div>

                        {!isTyping && (
                            <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in">
                                <div className="space-y-2">
                                    <label htmlFor="name" className="flex items-center gap-2 text-cyan-accent text-sm">
                                        <span className="text-zinc-600">01.</span> const userName =
                                    </label>
                                    <div className="flex items-center gap-2 bg-[#121212] border border-zinc-800 rounded-md p-1 focus-within:border-cyan-accent/50 transition-colors">
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="message" className="flex items-center gap-2 text-cyan-accent text-sm">
                                        <span className="text-zinc-600">02.</span> const message =
                                    </label>
                                    <div className="flex gap-2 bg-[#121212] border border-zinc-800 rounded-md p-1 focus-within:border-cyan-accent/50 transition-colors">
                                ...
                                <div className="pt-4 border-t border-zinc-800/50 flex justify-end">
                                    <button
                                        type="submit"
                                        className="group flex items-center gap-2 bg-cyan-accent/10 hover:bg-cyan-accent text-cyan-accent hover:text-black border border-cyan-accent/30 hover:border-cyan-accent font-mono text-sm py-2 px-6 rounded transition-all duration-300 cursor-pointer"
                                    >
