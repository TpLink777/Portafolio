...
const Inicio = () => {
    ...
    const email = "stivengomezmazo7@gmail.com";
    const subject = "Oferta de trabajo";
    const body = "Hola Stiven, vi tu portafolio y quisiera hablar contigo.";
        ...
        <>
            <div className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden pt-32 pb-20 md:pt-20">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <div className="absolute top-1/4 -left-48 w-96 h-96 bg-cyan-accent/10 rounded-full blur-3xl animate-float"></div>
                    <div className="absolute bottom-1/4 -right-48 w-96 h-96 bg-cyan-accent/10 rounded-full blur-3xl animate-float" style={{ animationDelay: '-3s' }}></div>
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-cyan-accent/5 rounded-full blur-[100px] opacity-50"></div>
                </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-8 order-2 lg:order-1 text-center lg:text-left">
                            <div ref={container} className="space-y-4">
                                ...
                                <h2 className="text-xl sm:text-2xl text-cyan-accent font-mono font-medium h-8 animate-fade-in-up delay-200">
                                    <span ref={textRef} className="typing-cursor">{fullText}</span>
                                </h2>
                            </div>
                            ...
                            <div className="flex items-center justify-center lg:justify-start gap-4 animate-fade-in-up delay-400">
                                <a
                                    ...
                                    className="w-12 h-12 flex items-center justify-center rounded-xl bg-zinc-800/80 border border-zinc-700 text-zinc-400 hover:bg-zinc-700 hover:text-white hover:border-zinc-600 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg shadow-black/20"
                                >
                                    <Github size={22} />
                                </a>
                                <a
                                    href="https://www.linkedin.com/in/stiven-gomez-mazo/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="w-12 h-12 flex items-center justify-center rounded-xl bg-zinc-800/80 border border-zinc-700 text-zinc-400 hover:bg-cyan-accent/20 hover:text-cyan-accent hover:border-cyan-accent/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg shadow-cyan-accent/20"
                                >
                                    <Linkedin size={22} />
                                </a>
                                <a
                            ...
                            <div className="pt-4 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 animate-fade-in-up delay-500">
                                <button className="group px-8 py-4 bg-linear-to-r from-cyan-accent to-navy-light rounded-xl font-semibold text-white shadow-lg shadow-cyan-accent/25 hover:shadow-cyan-accent/40 transition-all duration-300 flex items-center gap-3 relative overflow-hidden cursor-pointer hover:-translate-y-1 w-full sm:w-auto justify-center"
                                    ...
                                    <div className="absolute inset-0 bg-linear-to-r from-navy-light to-cyan-accent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                </button>
                            ...
                            <div className="grid grid-cols-3 gap-4 pt-8 border-t border-zinc-800/50 animate-fade-in-up delay-600 mt-8">
                                ...
                                <div className="text-center lg:text-left">
                                    <div className="text-3xl font-bold text-cyan-accent mb-1">9+</div>
                                    <div className="text-sm text-zinc-400 font-medium">Tecnologías<br />Dominadas</div>
                                </div>
                                <div className="text-center lg:text-left">
                                    <div className="text-3xl font-bold text-cyan-accent mb-1">100%</div>
                        ...
                        <div className="order-1 lg:order-2 flex justify-center lg:justify-end animate-scale-in">
                            <div className="relative group perspective-1000">
                                <div className="absolute -inset-1 rounded-full bg-linear-to-r from-cyan-accent via-cyan-accent to-navy-light opacity-30 group-hover:opacity-60 blur-xl transition-opacity duration-700 animate-pulse-glow"></div>
                                <div className="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-[450px] lg:h-[450px]">
                                    <div className="absolute inset-0 rounded-full border-2 border-zinc-700/50 group-hover:border-cyan-accent/50 transition-colors duration-500"></div>
                                    ...
                                    <div className="absolute top-10 -left-6 z-20 p-3 rounded-2xl bg-zinc-900/90 border border-zinc-700 shadow-xl backdrop-blur-md animate-float" style={{ animationDelay: '0s' }}>
                                        <Code2 className="text-cyan-accent" size={24} />
                                    </div>
                                    <div className="absolute bottom-16 -right-4 z-20 p-3 rounded-2xl bg-zinc-900/90 border border-zinc-700 shadow-xl backdrop-blur-md animate-float" style={{ animationDelay: '-2s' }}>
                                        <Database className="text-cyan-accent" size={24} />
                                    </div>
                                    <div className="absolute -top-4 right-12 z-20 p-3 rounded-2xl bg-zinc-900/90 border border-zinc-700 shadow-xl backdrop-blur-md animate-float" style={{ animationDelay: '-4s' }}>
                                        <Layout className="text-cyan-accent" size={24} />
                                    </div>
